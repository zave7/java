...
//	넘겨준다
	...
	public List<UserDto> getAll() throws ClassNotFoundException, SQLException {
	...
	public void add(com.kitri.jdbc.v8.dto.UserDto user) throws ClassNotFoundException, SQLException {
		Connection c = connectionMaker.makeConnection();	
		
		PreparedStatement ps = c.prepareStatement("insert into usertest(id, name, password) values(?,?,?)");
