...
public class FoodMain extends JFrame{
	...
	JButton mainMenu = new JButton(new ImageIcon(FoodMain.class.getResource("/foodCourt/mainbutton.jpg")));
	...
	JButton search = new JButton(new ImageIcon(FoodMain.class.getResource("/foodCourt/search.PNG")));
	JPanel panel_1 = new JPanel();
	JLabel menu = new JLabel(new ImageIcon(FoodMain.class.getResource("/foodCourt/menu.PNG")));
	JButton userInfo = new JButton(new ImageIcon(FoodMain.class.getResource("/foodCourt/mypage.PNG")));
	JLabel name = new JLabel("\uAD8C\uC601\uCC2C\uB2D8");
	JButton orderList = new JButton(new ImageIcon(FoodMain.class.getResource("/foodCourt/basket.png")));
