...
//		session.removeAttribute("userInfo");
	...
	public String getMember(HttpServletRequest request, HttpServletResponse response) {
		...
		System.out.println(((MemberDto)(session.getAttribute("userInfo"))).getId());
	...
	public String userInfoModify(HttpServletRequest request, HttpServletResponse response) {
		String result = "false";
		String id = request.getParameter("id");
		String pass = request.getParameter("pass");
		...
		memberDetailDto.setPass(pass);
		memberDetailDto.setEmailId(emailId);
		memberDetailDto.setEmailDomain(emailDomain);
		memberDetailDto.setTel1(tel1);
		memberDetailDto.setTel2(tel2);
		memberDetailDto.setTel3(tel3);
		memberDetailDto.setZipcode(zipcode);
		memberDetailDto.setAddress(address);
		memberDetailDto.setAddressDetail(addressDetail);
		try {
			result = MemberServiceImpl.getMemberService().userInfoModify(memberDetailDto);
